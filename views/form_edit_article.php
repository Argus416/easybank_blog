...
<body>
    ...
    <main class="dashboard">
        ...
        <div class="dashboard_body">
            ...
            <div class="dashboard_content form_article">
                <h3> Edit Article <?=$getArticle[0]->articleID?> </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-3 blog_photo_container">
                            <img class="article_banner"
                                src="<?= Helpers::imgToInsert('imgArticle', $getArticle[0]->articleImg) ?>"
                                alt="article_banner">
                        ...
                        <div class="row col-lg-9">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="artilce-title"
                                    value="<?=$getArticle[0]->articleTitle?>" id="title-article-edit">
                                <p class="text-danger err-text mt-1 mb-1 d-none">Veuillez remplir le champs</p>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="body-article-edit" name="artilce-body" rows="5"
                                    placeholder="Contenu de l'article"><?=$getArticle[0]->articleBody?></textarea>
                                <p class="text-danger err-text mt-1 mb-1 d-none">Veuillez remplir le champs</p>
                            </div>
    ...
    <?php else: header('Location:'.$urlGenerator->generate('err404')); ?>
    <?php endif;?>
